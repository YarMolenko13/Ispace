...
$(document).ready(function () {
	...
	// laguages
	$('.action-header__choose').click(function (e) {
		$('.action-header__morelang').css({ display: `flex` });
		$('.action-header__morelang').fadeIn();
		$(document).click(function (e) {
			if ($(e.target).closest('.action-header__choose').length) {
				return
			}
			else {
				$('.action-header__morelang').fadeOut();

			}
			$('.action-header__morelang').css({ display: `none` });
			// $('.action-header__morelang').fadeOut();
		});
	});
	// call
	...
	// about
	$('.about-popup-link').click(function (e) {
		e.preventDefault();
		$('html').css('overflow-y', 'hidden');
		$('body').css('overflow-y', 'hidden');
		$('.menu-header__body').fadeOut();
		$('.about-popup').css({ display: 'flex' });
		// if ($(window).innerWidth() <= 950) {
		// 	$('.header').css({ position: 'fixed', background: '#fff' }) ////
		// }
		$('.about-popup__close').click(function (e) {
			$('body').css({ "overflow": "scroll" });
	...
	// whywe
	$('.whywe__link').click(function (e) {
		$('.menu-header__body').fadeOut();;
		$('.works-popup').css({ display: 'none' });
		$('.works-popup').fadeOut();
	})
	// digits
	$('.digits__link').click(function (e) {
		$('.menu-header__body').fadeOut();
		$('.works-popup').css({ display: 'none' });
		$('.works-popup').fadeOut();
	})
	...
	// menu
	$('.menu-header__btn').click(function (e) {
		e.preventDefault();
		$("body").css("overflow-y", "hidden");
		$('.menu-header__body').css({ display: 'flex' });
		$('.menu-header__body').fadeIn();
		$('.menu-header__close').click(function (e) {
			$("body").css("overflow-y", "auto");
			$('.menu-header__body').css({ display: 'none' });
			$('.menu-header__body').fadeOut();
		})
	})
	...
	// 			$('.header').css({ position: 'fixed', background: '#fff' })
	// 		} else (
	// 			$('.header').css({ position: 'fixed', background: 'transparent' })
	// 		)
	// 	})
	// }
	...
	$(window).scroll(function () {
		if ($(window).innerWidth() >= 1045) {
			if ($(window).scrollTop() > 3213) {
				$('.aside-page').css({ display: 'none' })
			} else {
				$('.aside-page').css({ display: `flex` });
			}
		} else {
			$('.aside-page').css({ display: 'none' })
		}
